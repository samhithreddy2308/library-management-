    ...
    firebase.auth().onAuthStateChanged(user => {
        if(user) {
            ...
            $("#searchButton").click(function() {
                ...
                // Implement your search logic here using the author and id values
                // Update the "books" list and "booksAvailable" text accordingly
              });
            
              // Add book to cart
              $("#addToCartButton").click(function() {
                var selectedBook = // Retrieve the selected book details
            
                // Get the issue date and return date
                issueDate = $("#issueDateInput").val
              });
        }
        });
        firebase.auth().onAuthStateChanged(user => {
